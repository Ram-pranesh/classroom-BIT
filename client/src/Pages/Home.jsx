...
const Home = () => {
  ...
  const getClass = async () => {
    ...
    try {
      ...
      if (!userEmail && user?.role !== 'admin' && user?.role !== 'superadmin') {
      ...
      if (
        ...
        if (response.data.success) {
          ...
          console.log("Fetched classes for admin/superadmin:", sortedClass);
        } else {
          setClasses([]);
  ...
  const handleClassClick = (classId) => {
    ...
    if (
      ...
      // Unknown role, just show error or stay on page
